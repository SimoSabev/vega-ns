...
const Cards_Services = () => {
  return (
    ...
    >
      ...
      <div className="relative my-auto bg-[#242323] w-11/12 md:w-3/4 lg:w-10/12 flex flex-col lg:flex-row rounded-2xl shadow-lg">
      ...
      <div className="relative my-auto bg-slate-200 w-11/12 md:w-3/4 lg:w-10/12 flex flex-col lg:flex-row rounded-2xl shadow-lg">
        <div className="w-full lg:w-1/2 flex justify-center items-center">
          <Image
