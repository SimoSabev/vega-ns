        ...
        >
          ...
          <div className="max-w-3xl mx-auto">
            <motion.p
              ...
              className="text-md md:text-xl lg:text-xl xl:text-2xl text-left md:text-justify lg:text-justify xl:text-justify 2xl:text-justify text-slate-200 p-10 mt-36 md:mt-28 lg:mt-24 xl:mt-20 rounded-3xl"
            >
